...
?>
    ...
    <form method="post" action="">
        <fieldset>
            ...
            <button type="submit" name="submit1" value="insert">chercher les matieres</button>
        </fieldset>
    ...
    <form method="post" action="">
        <fieldset>
            ...
            <button type="reset">Effacer</button>
            <button type="submit" name="submitChercherMatieres" value="insert">chercher les matieres</button>
...
?>
    ...
    <?php
if (isset($_POST['submitChercherMatieres'])) {
    ...
    // Retrieve data from the "matiere" table
    $search_term = "%$matiere%";
    $sql = "SELECT * FROM matiere WHERE nom_mat LIKE :search_term";
    ...
    while ($row = $stmt->fetch()) {
        echo "<ul>";
        // echo "<li>" . $row['num_mat'] . "</li>";
        echo "<li>" . $row['nom_mat'] . "</li>";
        // echo "<li>" . $row['coef'] . "</li>";
        // echo "<li>" . $row['_num_ens'] . "</li>";
        echo "</ul>";
    }
}
?>
